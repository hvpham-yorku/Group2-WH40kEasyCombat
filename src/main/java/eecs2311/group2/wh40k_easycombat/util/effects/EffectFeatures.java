...
//
// Instead of spreading effect-related data across multiple classes, this class groups together the key attributes that define how an effect behaves:
...
// - Weapon name: restricts the effect to a specific weapon
// - Keyword text: used for adding special rules or abilities
//
// This abstraction separates "what an effect is" from "how it is applied", making the system more modular and easier to extend or modify.
